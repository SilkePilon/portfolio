...
export const home = {
  ...
  contact: {
    ...
    fields: [
      { key: 'Name', name: 'Name', placeholder: 'Jane Smith', type: 'text' },
      { key: 'Email', name: 'Email', placeholder: 'your@email.com', type: 'email' },
      { key: 'Phone', name: 'Phone', placeholder: '+00 0123456789', type: 'tel' },
      { key: 'Budget', name: 'Budget', placeholder: '$2000 - $5000', type: 'text' },
      { key: 'Message', name: 'Message', placeholder: 'My message is...', type: 'textarea' },
    ] as FormField[],
