...
export const labOptions = [
  ...
  { id: 'layers', name: 'Exploded UI', note: 'A live trading terminal — prices tick, orders fill, notifications arrive — explodes into backend, state, layout, component and interaction layers.', Component: Option10Layers },
]
