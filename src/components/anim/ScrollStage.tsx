...
/**
 * Scroll-driven stage: a sticky 100vh viewport over a `heightVh` spacer. One ScrollTrigger scrubs the
...
export function ScrollStage({
  ...
  useLayoutEffect(() => {
    ...
    if (!section) return
    // Deferred: this layout effect runs before the parent section's own init effect, which would otherwise
